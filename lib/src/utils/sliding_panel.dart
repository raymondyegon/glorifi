...
enum PanelState { OPEN, CLOSED, SNAP_POINT }
...
class _SlidingUpPanelState extends State<SlidingUpPanel>
  ...
  void initState() {
    ...
    _ac = AnimationController(
        ...
        value: widget.defaultPanelState == PanelState.SNAP_POINT
            ? widget.snapPoint
            : widget.defaultPanelState == PanelState.CLOSED
                ? 0
                : 1 //set the default panel state (i.e. set initial value of _ac)
        )
      ..addListener(() {
  ...
  void _onGestureEnd(Velocity v) {
    double minFlingVelocity = 1065.0;
    double kSnap = 20;
