...
class ACCApplicationInProgressScreen extends StatelessWidget {
  const ACCApplicationInProgressScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ACCExitContainer(
      title:
          "Your application is being processed, Please check back again later.",
      ctaButtons: [
        PrimaryButton(
          title: "Close",
          onTap: () async {
