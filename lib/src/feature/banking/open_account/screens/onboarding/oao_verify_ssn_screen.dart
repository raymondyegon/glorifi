...
import 'package:glorifi/src/feature/banking/open_account/screens/onboarding/oao_verify_itin_screen.dart';
...
class OAOVerifySSNScreen extends GetView<OAOController> {
  const OAOVerifySSNScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return OAOContainer(
        ...
        info: OAOScreensInfo.OAOVerifySSNScreen,
  ...
  List<Widget> _content(context) {
    ...
    return [
      GlorifiTextField(
        ...
        validator: GlorifiTextField.requiredSSN('SSN'),
        inputFormatters: [
      ...
      InkWell(
          ...
          onTap: () => Get.to(OAOVerifyITINScreen())).paddingOnly(top: 8, bottom: 8),
      OAOFooterNote(
          customText: TextSpan(children: [
